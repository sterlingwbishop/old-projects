...
public class WhackaMoleTest  {
    ...
    @Test
    public void testPlayWhackaMoleNoMisses() {
        whackaMole.clickOnSymbol(0,0);
    ...
    @Test
    public void testPlayWhackaMoleAllMisses() {
        whackaMole.addMiss();
        whackaMole.addMiss();
        whackaMole.addMiss();
        whackaMole.addMiss();
    ...
    @Test
    public void testPlayWhackaMoleMaxPoints() {
        whackaMole.clickOnSymbol(0,0);
        whackaMole.clickOnSymbol(0,1);
        whackaMole.clickOnSymbol(0,2);
        whackaMole.clickOnSymbol(0, 3);
        ...
        assertEquals(585, whackaMole.getTotalScore(), "Play WhackaMole 585 total score");
        assertEquals(0, whackaMole.getNumberOfMisses(), "Play WhackaMole 0 number of misses");
    }

    @Test
    public void testPlayWhackaMoleNoClicks() {
        assertEquals(0, whackaMole.getTotalScore(), "Play WhackaMole 0 total score");
        assertEquals(0, whackaMole.getNumberOfMisses(), "Play WhackaMole 0 number of misses");
    }
